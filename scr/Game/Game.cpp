...
bool Game::init() {
   ...
   // glm::mat4 modelMatrix_2 = glm::mat4(1.f);
    ...
    std::vector<std::pair<std::string, uint64_t>> tankBottomState;//animated down
    ...
    std::vector<std::pair<std::string, uint64_t>> tankRightState;//animated right
    ...
    std::vector<std::pair<std::string, uint64_t>> tankLeftState;//animated left
