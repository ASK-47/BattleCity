...
namespace Physics {
    ...
    struct AABB {//Axix Aligned Bounding Box
        AABB(const glm::vec2& _bottomLeft
    ...
    private:        
        ...
        /*static bool hasIntersection(const Collider& collider1
        ...
        static bool hasPositionIntersection(const std::shared_ptr<IGameObject>& pObject1
            , const glm::vec2& position1
